/**
 * HuKi Travel - i18n & Darkmode Test Automation Script
 * Command: node scripts/test-i18n-darkmode.js
 */
...
console.log("==================================================");
console.log("🧪 HUKI TRAVEL - AUTOMATED i18N & DARKMODE TEST SUITE");
console.log("==================================================\n");
...
properNames.forEach((name) => {
  // Ensure components don't hardcode translated forms of proper names
