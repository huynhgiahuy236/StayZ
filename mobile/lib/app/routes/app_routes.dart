...
import 'package:capstone_mobile/features/destination/presentation/pages/destination_detail_page.dart';
  ...
  static Map<String, WidgetBuilder> get routes => {
    ...
    destinationDetail: (context) {
      ...
      if (args is Map<String, dynamic>) {
        ...
        final initial = args['destination'] as DestinationModel?;
        return DestinationDetailPage(slug: slug, initialDestination: initial);
      } else if (args is DestinationModel) {
        return DestinationDetailPage(slug: args.slug, initialDestination: args);
      } else if (args is String) {
        return DestinationDetailPage(slug: args);
      }
      return const DestinationDetailPage(slug: 'bali');
    },
