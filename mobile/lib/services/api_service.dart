...
class ApiService {
  const ApiService({this.baseUrl = _defaultBaseUrl});
  ...
  Future<dynamic> put(
    ...
    Map<String, dynamic>? body,
    String? bearerToken,
  }) => _send('PUT', path, body: body, bearerToken: bearerToken);
  ...
  Future<dynamic> multipart(
    ...
    final request = http.MultipartRequest(method, uri)
      ...
      ..headers['Accept-Language'] = AppLocale.instance.code;
  ...
  Future<dynamic> _send(
    ...
    try {
      ...
      request.headers['Accept-Language'] = AppLocale.instance.code;
      if (bearerToken != null && bearerToken.isNotEmpty) {
        request.headers['Authorization'] = 'Bearer $bearerToken';
      }
      if (body != null ||
