...
abstract class StayzRepository {
  ...
  Future<DestinationModel?> getDestinationBySlug(String slug);
...
class ApiStayzRepository implements StayzRepository {
  ...
  Future<List<DestinationModel>> getDestinations({
    ...
    if (isDomestic != null) queryParams['is_domestic'] = isDomestic.toString();
    if (search != null && search.isNotEmpty) queryParams['search'] = search;
    queryParams['lang'] = AppLocale.instance.code;

    final queryString = Uri(queryParameters: queryParams).query;
    final path = queryString.isEmpty ? '/destinations' : '/destinations?$queryString';
  ...
  @override
  Future<DestinationModel?> getDestinationBySlug(String slug) async {
    try {
      final lang = AppLocale.instance.code;
      final data = await api.get('/destinations/$slug?lang=$lang');
      if (data is Map<String, dynamic>) {
