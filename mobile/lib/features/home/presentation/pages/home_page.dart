...
class _HomePageState extends State<HomePage> {
  ...
  late Future<BookingSummary?> _upcomingFuture;
  ...
  void initState() {
    ...
    _destinationsFuture = ApiStayzRepository.instance.getDestinations();
  ...
  Future<void> _refresh() async {
    ...
    final dests = ApiStayzRepository.instance.getDestinations();
    setState(() {
      _hotelsFuture = hotels;
      _destinationsFuture = dests;
      _upcomingFuture = _loadUpcomingBooking();
    });
    await hotels;
    await dests;
            ...
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  // Nơi du lịch hot (Trong & Ngoài nước) Carousel
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: EdgeInsets.fromLTRB(
                        responsive.horizontalPadding,
                      ...
                      child: SectionLabel(
                        title: tr('Điểm du lịch hot', 'Popular Destinations'),
                      ),
                    ),
                  ),
                  SliverToBoxAdapter(
                    child: SizedBox(
                      height: 250 * responsive.widthScale,
                      child: FutureBuilder<List<DestinationModel>>(
                        future: _destinationsFuture,
                        builder: (context, destSnapshot) {
                          final dests = destSnapshot.data ?? const [];
                          if (destSnapshot.connectionState == ConnectionState.waiting && dests.isEmpty) {
                  ...
                  SliverToBoxAdapter(
                    child: FutureBuilder<BookingSummary?>(
                      ...
                      builder: (context, bookingSnapshot) {
                        if (bookingSnapshot.hasError || bookingSnapshot.data == null) {
                          return const SizedBox.shrink();
                        }
