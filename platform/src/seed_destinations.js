...
const seedDestinations = [
  ...
  // --- THÊM MỚI: 12 QUỐC GIA ---
  {
    slug: "kuala-lumpur",
    name: { vi: "KUALA LUMPUR", en: "KUALA LUMPUR", ko: "쿠알라룸푸르", ja: "クアラルンプール", th: "กัวลาลัมเปอร์" },
    country: { vi: "Malaysia", en: "Malaysia", ko: "말레이시아", ja: "マレーシア", th: "มาเลเซีย" },
    is_domestic: false,
    rating: 4.8,
    discount_badge: "20%",
    hero_image: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1591160690555-796de6bc3526?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Thành phố hiện đại với tháp đôi Petronas lấp lánh và chợ Chinatown nhộn nhịp.",
      en: "Modern metropolis with iconic Petronas Twin Towers and vibrant Chinatown.",
      ko: "화려한 페트로나스 트윈 타워와 활기찬 차이나타운이 있는 현대적인 도시.",
      ja: "華やかなペトロナスタワーと活気あふれるチャイナタウンのある近代都市。",
      th: "เมืองทันสมัยพร้อมแทวนคู่เปโตรนาสและไชน่าทาวน์คึกคัก",
    },
    description: {
      vi: "Kuala Lumpur là thủ đô sôi động với PETRONAS Twin Towers huyền thoại, khu phố Malay truyền thống và ẩm thực đa dạng.",
      en: "Kuala Lumpur captivates with the legendary Petronas Twin Towers, traditional Malay quarters, and diverse cuisine.",
      ko: "쿠알라룸푸르는 전설적인 페트로나스 트윈 타워, 전통 말레이 상가, 다양한 음식으로 여행자를 매료시킵니다.",
      ja: "クアラルンプールは伝説のペトロナスタワー、伝統のマレー街区、多様なグルメで魅了します。",
      th: "กัวลาลัมเปอร์ดึงดูดนักท่องเที่ยวด้วยแทวนคู่เปโตรนาสในตำนาน ย่านมลายูดั้งเดิม และอาหารหลากหลาย",
    },
    foods: [
      {
        slug: "nasi-lemak",
        title: { vi: "Nasi Lemak & Satay", en: "Nasi Lemak & Satay", ko: "나시 레마크 & 사테", ja: "ナシレマク & サテ", th: "นาซีเลมัก & ซาเตย์" },
        description: {
          vi: "Cơm nấu nước cốt dừa thơm béo ăn kèm sốt sambal, trứng và xiên thịt nướng.",
          en: "Fragrant coconut rice served with sambal sauce, egg, and grilled meat skewers.",
          ko: "코코넛 우유 밥에 삼발 소스, 달걀, 구운 고기 꼬치를 곁들인 말레이시아 대표 음식.",
          ja: "ココナッツ風味のご飯にサンバルソース、目玉焼き、焼き鳥串を添えたマレー代表料理。",
          th: "ข้าวหอมมะพร้าวเสิร์ฟพร้อมซอสสัมบัล ไข่ดาว และไก่ย่างจัมโบ้",
        },
        image_url: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=85",
        price_range: "8 - 25 MYR",
        recommended_spots: [{ vi: "Nasi Lemak Wanjo, Bangsar", en: "Nasi Lemak Wanjo, Bangsar", ko: "나시 레마크 완조 방사르", ja: "ナシレマク ワンジョ バンサール", th: "นาซีเลมัก วานโจ บังซาร์" }],
      },
    ],
    activities: [
      {
        slug: "petronas-bukit-bintang",
        title: { vi: "Tháp Petronas & Khu Bukit Bintang", en: "Petronas Towers & Bukit Bintang", ko: "페트로나스 타워 & 부킷 빈탕", ja: "ペトロナスタワー & ブキッ・ビンタン", th: "แทวนเปโตรนาส & บูกิตบินตัง" },
        description: {
          vi: "Ngắm toàn cảnh Kuala Lumpur từ tầng 86 và dạo phố mua sắm Bukit Bintang.",
          en: "Enjoy 360-degree city views from level 86 and shop at vibrant Bukit Bintang.",
          ko: "86층에서 360도 도시 전경을 감상하고 활기찬 부킷 빈탕에서 쇼핑 즐기기.",
          ja: "86階から360度の都市パノラマを鑑賞し、活気あふれるブキッ・ビンタンでショッピング。",
          th: "ชมวิวเมือง 360 องศาจากชั้น 86 และช้อปปิ้งที่บูกิตบินตังคึกคัก",
        },
        image_url: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=800&q=85",
        category: "entertainment",
        location_name: { vi: "Kuala Lumpur, Malaysia", en: "Kuala Lumpur, Malaysia", ko: "말레이시아 쿠알라룸푸르", ja: "マレーシア クアラルンプール", th: "กัวลาลัมเปอร์, มาเลเซีย" },
      },
    ],
  },
  ...
  {
    slug: "manila",
    name: { vi: "MANILA", en: "MANILA", ko: "마닐라", ja: "マニラ", th: "มะนิลา" },
    country: { vi: "Philippines", en: "Philippines", ko: "필리핀", ja: "フィリピン", th: "ฟิลิปปินส์" },
    is_domestic: false,
    rating: 4.7,
    discount_badge: "30%",
    hero_image: "https://images.unsplash.com/photo-1514543256513-fcd523c97ff5?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1514543256513-fcd523c97ff5?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Thủ đô nhộn nhịp với Intramuros cổ kính và bãi biển Boracay tuyệt đẹp.",
      en: "Vibrant capital with historic Intramuros and stunning Boracay beaches.",
      ko: "역사적인 인트라무로스와 아름다운 보라카이 해변을 자랑하는 활기찬 수도.",
      ja: "歴史的なイントラムロスと美しいボラカイビーチのある活気ある首都。",
      th: "เมืองหลวงคึกคักพร้อมอินทรามูโรสโบราณและหาดบอราคายสวยงาม",
    },
    description: {
      vi: "Manila kết hợp hoàn hảo giữa lịch sử thuộc địa Tây Ban Nha, ẩm thực đường phố hấp dẫn và bãi biển Boracay nổi tiếng thế giới.",
      en: "Manila blends Spanish colonial history, tempting street food, and world-famous Boracay beaches.",
      ko: "마닐라는 스페인 식민지 역사,诱惑的な 길거리 음식, 세계적으로 유명한 보라카이 해변의 완벽한 조화를 이룹니다.",
      ja: "マニラはスペイン植民地時代、歴史、屋台グルメ、世界的に有名なボラカイビーチが魅力。",
      th: "มะนิลาผสมผสานประวัติศาสตร์สเปน อาหารข้างทางน่าลิ้มลอง และหาดบอราคายโด่งดังระดับโลก",
    },
    foods: [
      {
        slug: "adobo-lechon",
        title: { vi: "Adobo & Lechon", en: "Adobo & Lechon", ko: "아도보 & 레손", ja: "アドボ & レチョン", th: "อาโดโบ & เลชอน" },
        description: {
          vi: "Thịt heo/huhn adobo rim chua ngọt và thịt heo quay giòn da Lechon.",
          en: "Sweet and sour pork/chicken adobo with crispy roast pork Lechon.",
          ko: "달콤 새콤한 아도보 돼지고기/닭고기와 바삭한 레손 구이.",
          ja: "甘酸っぱいのアドボ豚バラ肉とクリスピーなレチョンローストポーク。",
          th: "หมู/ไก่อาโดโบรสหวานเปรี้ยวและหมูย่างกรอบเลชอน",
        },
        image_url: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=800&q=85",
        price_range: "150 - 500 PHP",
        recommended_spots: [{ vi: "Mendoza Haluhalo, Binondo", en: "Mendoza Haluhalo, Binondo", ko: "멘도자 할루할로 비논도", ja: "メンドサ アルハロ ビノンド", th: "เมนโดซ่า ฮาลูฮาโล บินอนโด" }],
      },
    ],
    activities: [
      {
        slug: "boracay-beach",
        title: { vi: "Boracay & White Beach", en: "Boracay & White Beach", ko: "보라카이 & 화이트비치", ja: "ボラカイ & ホワイトビーチ", th: "บอราคาย & หาดขาว" },
        description: {
          vi: "Tận hưởng bãi biển White Beach cát trắng mịn màng và hoàng hôn tuyệt đẹp.",
          en: "Relax on pristine White Beach and enjoy breathtaking sunsets.",
          ko: "아름다운 화이트 비치에서 휴식을 취하고 눈부신 일몰을 감상하세요.",
          ja: "白く美しいホワイトビーチでリラックスし、息をのむような夕日を鑑賞。",
          th: "ผ่อนคลายบนหาดขาวเงางามและชมพระอาทิตย์ตกที่งดงาม",
        },
        image_url: "https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?auto=format&fit=crop&w=800&q=85",
        category: "nature",
        location_name: { vi: "Boracay Island, Philippines", en: "Boracay Island, Philippines", ko: "필리핀 보라카이", ja: "フィリピン ボラカイ島", th: "เกาะบอราคาย, ฟิลิปปินส์" },
      },
    ],
  },
  ...
  {
    slug: "siem-reap",
    name: { vi: "SIEM REAP", en: "SIEM REAP", ko: "시엠리앗", ja: "シェムリアップ", th: "เสียมเรียบ" },
    country: { vi: "Cambodia", en: "Cambodia", ko: "캄보디아", ja: "カンボジア", th: "กัมพูชา" },
    is_domestic: false,
    rating: 4.9,
    discount_badge: "25%",
    hero_image: "https://images.unsplash.com/photo-1600096194534-95cf5ece04cf?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1600096194534-95cf5ece04cf?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1569154941061-e231b4725ef1?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Cửa ngõ đến đền Angkor Wat huyền thoại và văn hóa Khmer cổ đại.",
      en: "Gateway to the legendary Angkor Wat temples and ancient Khmer culture.",
      ko: "전설적인 앙코르왓 사원과 고대 크메르 문명의 관문.",
      ja: "伝説のアンコールワット寺院と古代クメール文化への玄関口。",
      th: "ประตูสู่วัดพระแก่วนครอันโด่งดังและวัฒนธรรมเขมรโบราณ",
    },
    description: {
      vi: "Siem Reap là điểm đến không thể bỏ qua để khám phá Angkor Wat - kỳ quan kiến trúc độc đáo nhất thế giới và ẩm thực Khmer độc đáo.",
      en: "Siem Reap is a must-visit destination to explore Angkor Wat - the most unique architectural wonder and authentic Khmer cuisine.",
      ko: "시엠리앗은 세계에서 가장 독특한 건축물인 앙코르왓과 진정한 크메르 음식을 탐험하는 필수 방문지입니다.",
      ja: "シェムリアップは、世界で最もユニークな建築アンティーであるアンコールワットと本物のクメール料理を探索する上で人気の訪問先です。",
      th: "เสียมเรียบเป็นจุดหมายปลายทางที่ต้องไปเยี่ยมชมเพื่อสำรวจพระแก่วนคร - มรดกทางสถาปัตยกรรมที่โดดเด่นที่สุดในโลกและอาหารเขมรแท้ๆ",
    },
    foods: [
      {
        slug: "amok-fish",
        title: { vi: "Amok Trey & Lap Khmer", en: "Amok Trey & Lap Khmer", ko: "아목 트레이 & 랩 크메르", ja: "アモク トレイ & ラップ クメール", th: "อาโมกตรี & ลับเขมร" },
        description: {
          vi: "Cá hấp bếp xô với nghệ và sữa dừa trong lá chuối cùng gỏi bò Khmer.",
          en: "Steamed fish with turmeric and coconut milk in banana leaf with Khmer beef salad.",
          ko: "바나나 잎에 튀김 커런드과 코코넛 밀크로 찐 생선과 크메르 소고기 샐러드.",
          ja: "バナナページにターメリックとココナッツミルクで蒸した魚とクメール牛肉のサラダ。",
          th: "ปลาอบเบนด์ใบกล้วยผสมขมิ้นกับกะทิและยำเนื้อเขมร",
        },
        image_url: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=800&q=85",
        price_range: "3 - 12 USD",
        recommended_spots: [{ vi: "Cuisine Wat Damnak, Siem Reap", en: "Cuisine Wat Damnak, Siem Reap", ko: "퀄린 왓담낵 시엠리앗", ja: "クイジーヌ ワットダムナック", th: "กวยซีน วัดดำนัก เสียมเรียบ" }],
      },
    ],
    activities: [
      {
        slug: "angkor-wat-sunrise",
        title: { vi: "Angkor Wat & Mặt Trời Mọc", en: "Angkor Wat & Sunrise", ko: "앙코르왓 & 일출", ja: "アンコールワット & 日の出", th: "พระแก่วนคร & พระอาทิตย์ขึ้น" },
        description: {
          vi: "Đón bình minh tại đền Angkor Wat huyền thoại và khám phá các ngôi đền cổ xung quanh.",
          en: "Watch legendary sunrise at Angkor Wat and explore ancient temples.",
          ko: "전설적인 앙코르왓에서 일출을 보고 고대 사원들을 탐험하세요.",
          ja: "伝説のアンコールワットで日の出を見て、古代の寺院を探索。",
          th: "ชมพระอาทิตย์ขึ้นที่พระแก่วนครอันโด่งดังและสำรวจวัดโบราณรอบๆ",
        },
        image_url: "https://images.unsplash.com/photo-1600096194534-95cf5ece04cf?auto=format&fit=crop&w=800&q=85",
        category: "culture",
        location_name: { vi: "Siem Reap, Cambodia", en: "Siem Reap, Cambodia", ko: "캄보디아 시엠리앗", ja: "カンボジア シェムリアップ", th: "เสียมเรียบ, กัมพูชา" },
      },
    ],
  },
  ...
  {
    slug: "yangon",
    name: { vi: "YANGON", en: "YANGON", ko: "양곤", ja: "ヤンゴン", th: "ย่างกุ้ง" },
    country: { vi: "Myanmar", en: "Myanmar", ko: "미얀마", ja: "ミャンマー", th: "เมียนมาร์" },
    is_domestic: false,
    rating: 4.7,
    discount_badge: "20%",
    hero_image: "https://images.unsplash.com/photo-1569154941061-e231b4725ef1?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1569154941061-e231b4725ef1?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1562509277-4aa8c29be09c?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Thủ đô cũ với Pagoda Shwedagon dát vàng lấp lánh và phố cổ sôi động.",
      en: "Old capital with gleaming Shwedagon Pagoda and bustling old town.",
      ko: "반짝이는 쉐다공 파고다와 활기찬 올드타운이 있는 옛 수도.",
      ja: "輝くシュエダゴン・パゴダと活気ある旧市街がある昔ながらの首都。",
      th: "เมืองหลวงเก่าพร้อมพระเจดีย์ทองเชฟดากอนเรืองแสงและย่านเมืองเก่าคึกคัก",
    },
    description: {
      vi: "Yangon mang đến trải nghiệm độc đáo với Shwedagon Pagoda huyền thoại, chợ Bogyoke Aung San nhộn nhịp và ẩm thực Myanmar truyền thống.",
      en: "Yangon offers unique experiences with the legendary Shwedagon Pagoda, bustling Bogyoke Market, and authentic Myanmar cuisine.",
      ko: "양곤은 전설적인 슈에다곤 파고다, 활기찬 보지오 아웅산 시장, 진정한 미얀마 음식의 독특한 경험을 제공합니다.",
      ja: "ヤンゴンは伝説のシュエダゴン・パゴダ活気あふれるボギョー・アウンサン市場、本物のミャンマー料理でユニークな体験を提供します。",
      th: "ย่างกุ้งมอบประสบการณ์ที่เป็นเอกลักษณ์พร้อมพระเจดีย์ทองเชฟดากอนในตำนาน ตลาดโบจีเอานซานคึกคัก และอาหารเมียนมาร์แท้ๆ",
    },
    foods: [
      {
        slug: "mohinga-tea-leaf",
        title: { vi: "Mohinga & Tea Leaf Salad", en: "Mohinga & Tea Leaf Salad", ko: "모힝가 & 티 리프 샐러드", ja: "モヒンガ & ティーリーフサラダ", th: "โมฮิงกา & สลัดใบชา" },
        description: {
          vi: "Mì cá tươi Mohinga đặc trưng và salad lá trà chua giòn của Myanmar.",
          en: "Signature fish noodle Mohinga and crispy sour tea leaf salad.",
          ko: "시그니처 생선 누들 모힝가와 바삭 새콤한 티 리프 샐러드.",
          ja: "シグネチャーフィッシュヌードル モヒンガとカリカリ酸っぱいティーリーフサラダ。",
          th: "ราเมนปลาสูตรพิเศษโมฮิงกาและสลัดใบชาเปรี้ยวกรอบของเมียนมาร์",
        },
        image_url: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=800&q=85",
        price_range: "1000 - 5000 MMK",
        recommended_spots: [{ vi: "Mote Lone Yay Paw, Yangon", en: "Mote Lone Yay Paw, Yangon", ko: "모테 로네 예이 파우 양곤", ja: "モテ ロネ ヤイ パウ ヤンゴン", th: "โมเต โลเน ยาย ปาว ย่างกุ้ง" }],
      },
    ],
    activities: [
      {
        slug: "shwedagon-pagoda",
        title: { vi: "Pagoda Shwedagon & Hồ Inya", en: "Shwedagon Pagoda & Inya Lake", ko: "쉐다공 파고다 & 인야 호수", ja: "シュエダゴン・パゴダ & インセ湖", th: "พระเจดีย์ทองเชฟดากอน & ทะเลสาบอินยา" },
        description: {
          vi: "Chiêm ngưỡng Pagoda dát vàng lấp lánh về đêm và dạo quanh hồ Inya thơ mộng.",
          en: "Marvel at the gleaming gold pagoda at night and stroll around scenic Inya Lake.",
          ko: "밤에 반짝이는 금색 파고다를 감상하고 풍경이 좋은 인야호를 산책하세요.",
          ja: "夜に輝く黄金のパゴダを間近で見て、景色の良いインセ湖畔を散策。",
          th: "ชื่นชมพระเจดีย์ทองเรืองแสงยามค่ำคืนและเดินเล่นรอบทะเลสาบอินยาที่งดงาม",
        },
        image_url: "https://images.unsplash.com/photo-1569154941061-e231b4725ef1?auto=format&fit=crop&w=800&q=85",
        category: "culture",
        location_name: { vi: "Yangon, Myanmar", en: "Yangon, Myanmar", ko: "미얀마 양곤", ja: "ミャンマー ヤンゴン", th: "ย่างกุ้ง, เมียนมาร์" },
      },
    ],
  },

  // --- DESTINATION 11: BEIJING (TRUNG QUỐC) ---
  {
    slug: "beijing",
    name: { vi: "BẮC KINH", en: "BEIJING", ko: "베이징", ja: "北京", th: "ปักกิ่ง" },
    country: { vi: "Trung Quốc", en: "China", ko: "중국", ja: "中国", th: "จีน" },
    is_domestic: false,
    rating: 4.8,
    discount_badge: "20%",
    hero_image: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Thủ đô ngàn năm với Vạn Lý Trường Thành, Tử Cấm Thành và Thiên An Môn.",
      en: "Millennia-old capital with Great Wall, Forbidden City, and Tiananmen.",
      ko: "만리장성과 자금성, 천안문이 있는 천년 고도.",
      ja: "万里の長城と紫禁城、天安門がある千年の都。",
      th: "เมืองหลวงพันปีพร้อมกำแพงเมืองจีน พระราชวังต้องห้าม และเทียนอันเหมิน",
    },
    description: {
      vi: "Bắc Kinh kết hợp hài hòa giữa di sản thế giới Vạn Lý Trường Thành, ẩm thực vịt quay Bắc Kinh nổi tiếng và hiện đại của Olympic 2008.",
      en: "Beijing blends the Great Wall heritage, world-famous Peking duck, and modern Olympic 2008 architecture.",
      ko: "베이징은 만리장성 유산, 세계적으로 유명한 베이징 오리, 2008 올림픽 현대 건축이 어우러진 도시입니다.",
      ja: "北京は万里の長城、世界的に有名な北京ダック、2008年オリンピックの現代建築が融合した都市。",
      th: "ปักกิ่งผสมผสานมรดกกำแพงเมืองจีน เป็ดปักกิ่งระดับโลก และสถาปัตยกรรมสมัยใหม่โอลิมปิก 2008",
    },
    foods: [
      {
        slug: "peking-duck",
        title: { vi: "Vịt Quay Bắc Kinh & Mì Hoành Thánh", en: "Peking Duck & Wonton Noodles", ko: "베이징 덕 & 원턴 국수", ja: "北京ダック & ワンタン麺", th: "เป็ดปักกิ่ง & บะหมี่เกี๊ยว" },
        description: {
          vi: "Vịt quay da giòn với bánh tráng mỏng cuốn và mì hoành thánh thơm ngon.",
          en: "Crispy skin Peking duck with thin pancakes and savory wonton noodle soup.",
          ko: "바삭한 베이징 덕, 얇은 팬케이크, 감칠맛 나는 원턴 국수.",
          ja: "クリスピーな北京ダック、薄餅、旨味ワンタン麺。",
          th: "เป็ดปักกิ่งกรอบนอกนุ่มในพร้อมแผ่นแป้งบางและบะหมี่เกี๊ยวหอมอร่อย",
        },
        image_url: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=800&q=85",
        price_range: "80 - 300 CNY",
        recommended_spots: [{ vi: "Quán Vịt Quay Quanjude (全聚德)", en: "Quanjude Roast Duck", ko: "취안취더 오리구이", ja: "全聚徳 北京ダック", th: "ร้านเป็ดย่างเฉวียนจูเต๋อ" }],
      },
    ],
    activities: [
      {
        slug: "great-wall-forbidden-city",
        title: { vi: "Vạn Lý Trường Thành & Tử Cấm Thành", en: "Great Wall & Forbidden City", ko: "만리장성 & 자금성", ja: "万里の長城 & 紫禁城", th: "กำแพงเมืองจีน & พระราชวังต้องห้าม" },
        description: {
          vi: "Đi bộ trên Vạn Lý Trường Thành và khám phá Tử Cấm Thành sừng sững 600 năm.",
          en: "Walk on the Great Wall and explore the 600-year-old Forbidden City.",
          ko: "만리장성 위를 걸으며 600년 역사의 자금성을 탐험하세요.",
          ja: "万里の長城を歩き、600年の歴史を持つ紫禁城を探検。",
          th: "เดินบนกำแพงเมืองจีนและสำรวจพระราชวังต้องห้ามอายุ 600 ปี",
        },
        image_url: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=800&q=85",
        category: "culture",
        location_name: { vi: "Bắc Kinh, Trung Quốc", en: "Beijing, China", ko: "중국 베이징", ja: "中国 北京", th: "ปักกิ่ง, จีน" },
      },
    ],
  },

  // --- DESTINATION 12: SYDNEY (ÚC) ---
  {
    slug: "sydney",
    name: { vi: "SYDNEY", en: "SYDNEY", ko: "시드니", ja: "シドニー", th: "ซิดนีย์" },
    country: { vi: "Úc", en: "Australia", ko: "호주", ja: "オーストラリア", th: "ออสเตรเลีย" },
    is_domestic: false,
    rating: 4.9,
    discount_badge: "15%",
    hero_image: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=1600&q=85",
    gallery: [
      "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=1200&q=85",
      "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=1200&q=85",
    ],
    summary: {
      vi: "Thành phố cảng biển xinh đẹp với Nhà hát Opera và Cầu Cảng Sydney.",
      en: "Stunning harbor city with Opera House and Sydney Harbour Bridge.",
      ko: "오페라 하우스와 시드니 하버 브리지가 있는 멋진 항구 도시.",
      ja: "オペラハウスとハーバーブリッジがある素晴らしい港町。",
      th: "เมืองท่าสวยงามพร้อมโอเปร่าเฮาส์และสะพานซิดนีย์ฮาร์เบอร์",
    },
    description: {
      vi: "Sydney là điểm đến đẳng cấp với Nhà hát Opera mang tính biểu tượng, Bãi biển Bondi tuyệt đẹp và vườn thú với gấu Koala.",
      en: "Sydney offers iconic Opera House, gorgeous Bondi Beach, and zoo with koala bears.",
      ko: "시드니는 상징적인 오페라 하우스, 아름다운 본다이 비치, 코알라 동물원이 있는 세계적 도시입니다.",
      ja: "シドニーは象徴的なオペラハウス、素晴らしいボンダイビーチ、コアラ動物園がある世界的な都市。",
      th: "ซิดนีย์คือจุดหมายปลายทางระดับโลกพร้อมโอเปร่าเฮาส์อันเป็นสัญลักษณ์ หาดบอนไดอันสวยงาม และสวนสัตว์ที่มีโคอาลา",
    },
    foods: [
      {
        slug: "meat-pie-fish-chips",
        title: { vi: "Meat Pie & Fish & Chips", en: "Meat Pie & Fish & Chips", ko: "미트 파이 & 피쉬 앤 칩스", ja: "ミートパイ & フィッシュ&チップス", th: "มีทพาย & ปลาและมันฝรั่งทอด" },
        description: {
          vi: "Bánh nhân thịt Meat Pie nướng giòn và tôm hùm Barramundi nướng bơ chanh.",
          en: "Flaky Meat Pie with savory filling and grilled Barramundi fish with lemon butter.",
          ko: "바삭한 패스트리 미트 파이와 레몬 버터 그릴 바라문디 생선.",
          ja: "サクサクのパイ生地のミートパイとレモンバターのバラマンディグリル。",
          th: "พายเนื้อเปลือกกรอบและปลาบาร์รามันดีย่างเนยมะนาว",
        },
        image_url: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=800&q=85",
        price_range: "15 - 40 AUD",
        recommended_spots: [{ vi: "Harry's Cafe de Wheels, Darling Harbour", en: "Harry's Cafe de Wheels", ko: "해리스 카페 드 휠스", ja: "ハリーズ カフェ ド ウィールズ", th: "แฮร์รี่ส์ คาเฟ่ เดอะ วีลส์" }],
      },
    ],
    activities: [
      {
        slug: "opera-house-bondi",
        title: { vi: "Nhà Hát Opera & Bãi Bondi", en: "Opera House & Bondi Beach", ko: "오페라 하우스 & 본다이 비치", ja: "オペラハウス & ボンダイビーチ", th: "โอเปร่าเฮาส์ & หาดบอนได" },
        description: {
          vi: "Ngắm Nhà hát Opera từ cầu cảng và lướt sóng tại bãi biển Bondi nổi tiếng.",
          en: "View Opera House from Harbour Bridge and surf at famous Bondi Beach.",
          ko: "하버 브리지를 배경으로 오페라 하우스를 감상하고 본다이 비치에서 서핑을 즐기세요.",
          ja: "ハーバーブリッジからオペラハウスを眺め、有名なボンダイビーチでサーフィン。",
          th: "ชมโอเปร่าเฮาส์จากสะพานฮาร์เบอร์และเล่นเซิร์ฟที่หาดบอนไดอันมีชื่อเสียง",
        },
        image_url: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=800&q=85",
        category: "entertainment",
        location_name: { vi: "Sydney, Úc", en: "Sydney, Australia", ko: "호주 시드니", ja: "オーストラリア シドニー", th: "ซิดนีย์, ออสเตรเลีย" },
      },
    ],
  },
];
