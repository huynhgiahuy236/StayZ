...
export type DestinationFood = {
  ...
  image_url?: string;
  price_range?: string;
  recommended_spots?: (I18nString | string)[];
};
...
export type DestinationActivity = {
  ...
  description?: I18nString | string;
  image_url?: string;
  category?: "nature" | "culture" | "entertainment" | "checkin";
  location_name?: I18nString | string;
};
...
export type Destination = {
  ...
  country?: I18nString | string;
  is_domestic?: boolean;
  rating?: number;
  discount_badge?: string;
  hero_image?: string;
  gallery?: string[];
  summary?: I18nString | string;
  description?: I18nString | string;
  foods?: DestinationFood[];
  activities?: DestinationActivity[];
  properties?: Hotel[] | string[];
};
